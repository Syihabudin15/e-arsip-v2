/*
  ...
  - You are about to drop the column `permohonanKreditId` on the `document` table. All the data in the column will be lost.
...
-- DropIndex
DROP INDEX `Document_permohonanKreditId_idx` ON `document`;

-- AlterTable
ALTER TABLE `document` DROP COLUMN `permohonanKreditId`;
